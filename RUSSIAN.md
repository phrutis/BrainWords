...
Суть работы батника: Если использованой памяти в gpu карте менее 2 ГБ<br>
Вероятно произошел какой нибудь сбой сервера, интернета или ошибка, клиент остановился.<br>
Каждые 20 минут идет проверка, елсли клиент отвалился то будет перезапущен автоматичиски. <br>
...
## Задача 1-11 (Завершено :white_check_mark:)
...
abcdefghijklm nopqrstuvwxyz.,!
<br>
Генерация - длина 10 <br>
Текущая позиция поиска "A"<br>
