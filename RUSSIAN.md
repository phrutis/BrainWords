...
### Реальные находки пула
Шаг 1<br>
Алфааит: @1234567890 abcdefghijklmnopqrstuvwxyz.,<br>
Фразы длина 1-11 символов<br>

| Дата | Пароль | Адрес | Баланс $ |
|------|------------|---------|-----------|
...
Возможный повторный проход с ETH<br>

### Следующий вариант:<br>
Длина фразы 1-11 символов<br>
Как в варианте выше только добавляется константный префикс из заглавной буквы<br>
```Hello my btc```<br>
```Good day 2012```<br>
```Cryptoman22```<br>
```Superman 2009```<br>
```Test1test123<```br>
Комбинаций префикса заглавных 26 букв.<br>
Возможный повторный проход с монетой ETH<br>

### Следующий этап (возможно отдельный сервер):<br>
Все возможные символы длина 1-9 BTC<br>
Все возможные символы длина 1-9 ETH<br>
Здесь генерируем сложные Brainwallet пароли:<br>
```<-BoSs->```<br>
```Br@#N&7x~```<br>
```x.*&?toP5```<br>
```V@sya!!.,```<br>
...
Возможный поиск ETH Camp2 длина 1-7<br>
